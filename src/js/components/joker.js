                ...
                var shelf = `<div class="product product--shelf product--shelf-flip">
                    ...
                    <div class="product__back">      <span class="product__id" data-product-id="${product.productId}"></span>
                        ...
                        <div class="product__actions">
                            <a class="button product__link" title="${product.name}" href="${product.link}">Ver Produto</a>
                            <a class="button button--primary product__buy" href="${product.link}" data-product-id="${product.productId}">Compre Rápido</a></div>
                    </div>
                    </div>
                </div>`
                html += `<li>${shelf}</li>`;
